...
FAIL_MESSAGE	db 'Error: DOS function 48H failed!', 0dh, 0ah, '$'
SUCCESS_MESSAGE	db 'DOS function 48H successeful!', 0dh, 0ah, '$'
...
BEGIN:
		...
		; ask dos for 64 kb memory before setting memory free
		mov ah, 48h
		mov bx, 1000h
		int 21h
		; handle CF
